...
import pytz
import time  # Añadido import que faltaba
...
class DatabaseManager:
  ...
  def _initialize_connection(self):
    ...
    for attempt in range(max_retries):
      try:
        self.connection = st.connection("mariadb_meetings_db", type="sql")
  ...
  with col2:
    ...
    with st.expander("Limpieza de Datos Antiguos"):
      ...
      try:
        ...
        st.error(f"Error al verificar reuniones antiguas: {str(e)}")
